      ...
      <div>
         <div className='hero-cont'>
            <div className='hero-text-cont'>
               ...
               {Object.keys(loggeduser).length > 0 &&<button className='create-cv-button' onClick={()=>navigate('/makecv')}>create my cv</button>}
               {!Object.keys(loggeduser).length > 0 &&<button className='create-cv-button' onClick={()=>navigate('/sign')}>First step to success</button>}
            </div>
